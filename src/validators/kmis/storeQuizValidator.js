...
exports.storeQuizValidator = [
  body("topicId")
    .notEmpty()
    .withMessage("Topik kuis wajib dipilih.")
    .bail()
    .isInt()
    .withMessage("Topik kuis harus berupa angka.")
    .bail()
    .custom(async (value) => {
      const category = await knex("kmis_topics")
        .where("id", value)
        .whereNull("deleted_at")
        .first();
      if (!category) {
        throw new Error("Topik kuis yang Anda pilih tidak ditemukan.");
      }
      return true;
    }),
